...
public class InitialDataConfig {
    ...
    @Autowired
    public InitialDataConfig(JpaCategoryRepository jpaCategoryRepository, JpaRoleRepository jpaRoleRepository, JpaProductRepository jpaProductRepository, JpaUserRepository userRepository, UserService userService) {
